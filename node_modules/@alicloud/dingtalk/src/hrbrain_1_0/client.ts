...
export class HrbrainLabelEmpDeleteHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class HrbrainLabelEmpDeleteRequest extends $tea.Model {
  /**
   * @remarks
   * This parameter is required.
   */
  ...
  static types(): { [key: string]: any } {
    return {
      labelCode: 'string',
      workNos: { 'type': 'array', 'itemType': 'string' },
    };
  }
...
export class HrbrainLabelEmpDeleteResponseBody extends $tea.Model {
  requestId?: string;
  result?: boolean;
  success?: boolean;
  static names(): { [key: string]: string } {
...
export class HrbrainLabelEmpDeleteResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
  body?: HrbrainLabelEmpDeleteResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      statusCode: 'statusCode',
...
export default class Client extends OpenApi {
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns HrbrainLabelEmpDeleteResponse
   */
  async hrbrainLabelEmpDeleteWithOptions(request: HrbrainLabelEmpDeleteRequest, headers: HrbrainLabelEmpDeleteHeaders, runtime: $Util.RuntimeOptions): Promise<HrbrainLabelEmpDeleteResponse> {
    Util.validateModel(request);
    let body : {[key: string ]: any} = { };
    if (!Util.isUnset(request.labelCode)) {
      body["labelCode"] = request.labelCode;
    ...
    if (!Util.isUnset(request.workNos)) {
    ...
    return $tea.cast<HrbrainLabelEmpDeleteResponse>(await this.execute(params, req, runtime), new HrbrainLabelEmpDeleteResponse({}));
  }
   ...
   * @returns HrbrainLabelEmpDeleteResponse
   */
  async hrbrainLabelEmpDelete(request: HrbrainLabelEmpDeleteRequest): Promise<HrbrainLabelEmpDeleteResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new HrbrainLabelEmpDeleteHeaders({ });
    return await this.hrbrainLabelEmpDeleteWithOptions(request, headers, runtime);
  }
