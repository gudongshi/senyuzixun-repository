...
export class RoleMapValue extends $tea.Model {
  /**
   * @example
   * MANAGER
   */
...
export class BatchQueryRolesHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class BatchQueryRolesRequest extends $tea.Model {
  /**
   * @remarks
   * This parameter is required.
   */
  dentryUuidList?: string[];
  /**
   * @remarks
   * This parameter is required.
   * 
  ...
  static types(): { [key: string]: any } {
    return {
      dentryUuidList: { 'type': 'array', 'itemType': 'string' },
      unionId: 'string',
    };
  }
...
export class BatchQueryRolesResponseBody extends $tea.Model {
  roleMap?: { [key: string]: RoleMapValue[] };
  static names(): { [key: string]: string } {
    return {
      roleMap: 'roleMap',
    };
  ...
  static types(): { [key: string]: any } {
    return {
      roleMap: { 'type': 'map', 'keyType': 'string', 'valueType': { 'type': 'array', 'itemType': RoleMapValue } },
    };
  }
...
export class BatchQueryRolesResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
  body?: BatchQueryRolesResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      statusCode: 'statusCode',
...
export class ListOperationLogsRequest extends $tea.Model {
  endTime?: number;
  option?: ListOperationLogsRequestOption;
  startTime?: number;
  static names(): { [key: string]: string } {
    return {
      endTime: 'endTime',
...
export class ListOperationLogsResponseBody extends $tea.Model {
  items?: ListOperationLogsResponseBodyItems[];
  /**
   * @example
   * next_token
   */
  ...
  static types(): { [key: string]: any } {
    return {
      items: { 'type': 'array', 'itemType': ListOperationLogsResponseBodyItems },
      nextToken: 'string',
      totalCount: 'number',
    };
  }
...
export class ListOperationLogsRequestOption extends $tea.Model {
  /**
   * @example
   * 下载:download_file
   */
...
export class ListOperationLogsResponseBodyItems extends $tea.Model {
  /**
   * @example
   * add_permission
   */
...
export default class Client extends OpenApi {
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns BatchQueryRolesResponse
   */
  async batchQueryRolesWithOptions(request: BatchQueryRolesRequest, headers: BatchQueryRolesHeaders, runtime: $Util.RuntimeOptions): Promise<BatchQueryRolesResponse> {
    Util.validateModel(request);
    let query : {[key: string ]: any} = { };
    if (!Util.isUnset(request.unionId)) {
      query["unionId"] = request.unionId;
    ...
    let body : {[key: string ]: any} = { };
    if (!Util.isUnset(request.dentryUuidList)) {
    ...
    return $tea.cast<BatchQueryRolesResponse>(await this.execute(params, req, runtime), new BatchQueryRolesResponse({}));
  }
   ...
   * @returns BatchQueryRolesResponse
   */
  async batchQueryRoles(request: BatchQueryRolesRequest): Promise<BatchQueryRolesResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new BatchQueryRolesHeaders({ });
    return await this.batchQueryRolesWithOptions(request, headers, runtime);
  }
   ...
   */
  async cleanFileWithOptions(request: CleanFileRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<CleanFileResponse> {
    Util.validateModel(request);
    let body : {[key: string ]: any} = { };
    if (!Util.isUnset(request.cleanReason)) {
