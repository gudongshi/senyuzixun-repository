...
export class RevokeSalaryArchivesHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class RevokeSalaryArchivesRequest extends $tea.Model {
  /**
   * @remarks
   * This parameter is required.
   * 
...
export class RevokeSalaryArchivesResponseBody extends $tea.Model {
...
export class RevokeSalaryArchivesResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
  body?: RevokeSalaryArchivesResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      statusCode: 'statusCode',
...
export class SaveSalaryArchivesHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class SaveSalaryArchivesRequest extends $tea.Model {
  /**
   * @example
   * 转正
   */
  adjustMemo?: string;
  contents?: SaveSalaryArchivesRequestContents[];
  /**
   * @remarks
   * This parameter is required.
   * 
  ...
  static types(): { [key: string]: any } {
    return {
      adjustMemo: 'string',
      contents: { 'type': 'array', 'itemType': SaveSalaryArchivesRequestContents },
      effectiveDate: 'string',
      opUserId: 'string',
      userId: 'string',
    };
...
export class SaveSalaryArchivesResponseBody extends $tea.Model {
  result?: { [key: string]: any };
  static names(): { [key: string]: string } {
    return {
      result: 'result',
...
export class SaveSalaryArchivesResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
  body?: SaveSalaryArchivesResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      statusCode: 'statusCode',
...
export class SaveSalaryArchivesRequestContents extends $tea.Model {
  /**
   * @remarks
   * This parameter is required.
   * 
...
export default class Client extends OpenApi {
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns RevokeSalaryArchivesResponse
   */
  async revokeSalaryArchivesWithOptions(request: RevokeSalaryArchivesRequest, headers: RevokeSalaryArchivesHeaders, runtime: $Util.RuntimeOptions): Promise<RevokeSalaryArchivesResponse> {
    Util.validateModel(request);
    let body : {[key: string ]: any} = { };
    ...
    return $tea.cast<RevokeSalaryArchivesResponse>(await this.execute(params, req, runtime), new RevokeSalaryArchivesResponse({}));
  }
   ...
   * @returns RevokeSalaryArchivesResponse
   */
  async revokeSalaryArchives(request: RevokeSalaryArchivesRequest): Promise<RevokeSalaryArchivesResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new RevokeSalaryArchivesHeaders({ });
    return await this.revokeSalaryArchivesWithOptions(request, headers, runtime);
  }
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns SaveSalaryArchivesResponse
   */
  async saveSalaryArchivesWithOptions(request: SaveSalaryArchivesRequest, headers: SaveSalaryArchivesHeaders, runtime: $Util.RuntimeOptions): Promise<SaveSalaryArchivesResponse> {
    Util.validateModel(request);
    let body : {[key: string ]: any} = { };
    if (!Util.isUnset(request.adjustMemo)) {
    ...
    return $tea.cast<SaveSalaryArchivesResponse>(await this.execute(params, req, runtime), new SaveSalaryArchivesResponse({}));
  }
   ...
   * @returns SaveSalaryArchivesResponse
   */
  async saveSalaryArchives(request: SaveSalaryArchivesRequest): Promise<SaveSalaryArchivesResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new SaveSalaryArchivesHeaders({ });
    return await this.saveSalaryArchivesWithOptions(request, headers, runtime);
  }
