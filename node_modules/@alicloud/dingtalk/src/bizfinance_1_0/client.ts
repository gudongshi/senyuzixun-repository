...
export class QueryMultiCompanyInfoRequest extends $tea.Model {
  startStatus?: boolean;
  static names(): { [key: string]: string } {
    return {
...
export class QueryReceiptDetailForInvoiceResponseBodyResultSpecificBusinessInfoSpecificBusinessInfoList extends $tea.Model {
  areaUnit?: string;
  carNo?: string;
  city?: string;
  crossCityFlg?: string;
  ...
  project?: string;
  projectNo?: string;
  propertyCertificateNumber?: string;
  province?: string;
  realEstateDetailedAddress?: string;
  spanRegionManageNo?: string;
  static names(): { [key: string]: string } {
    return {
      areaUnit: 'areaUnit',
      carNo: 'carNo',
...
export class QueryReceiptDetailForInvoiceResponseBodyResultSpecificBusinessInfo extends $tea.Model {
  /**
   * @example
   * lease
   */
  specialBizCode?: string;
  specificBusinessInfoList?: QueryReceiptDetailForInvoiceResponseBodyResultSpecificBusinessInfoSpecificBusinessInfoList[];
  static names(): { [key: string]: string } {
    return {
  ...
  static types(): { [key: string]: any } {
    return {
      specialBizCode: 'string',
      specificBusinessInfoList: { 'type': 'array', 'itemType': QueryReceiptDetailForInvoiceResponseBodyResultSpecificBusinessInfoSpecificBusinessInfoList },
    };
  }
...
export class QueryReceiptDetailForInvoiceResponseBodyResult extends $tea.Model {
   ...
   */
  source?: string;
  specificBusinessInfo?: QueryReceiptDetailForInvoiceResponseBodyResultSpecificBusinessInfo;
  /**
   * @example
   * agree
   */
...
export default class Client extends OpenApi {
   ...
   */
  async queryMultiCompanyInfoWithOptions(request: QueryMultiCompanyInfoRequest, headers: QueryMultiCompanyInfoHeaders, runtime: $Util.RuntimeOptions): Promise<QueryMultiCompanyInfoResponse> {
    Util.validateModel(request);
    let query : {[key: string ]: any} = { };
   ...
   * @returns QueryMultiCompanyInfoResponse
   */
  async queryMultiCompanyInfo(request: QueryMultiCompanyInfoRequest): Promise<QueryMultiCompanyInfoResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new QueryMultiCompanyInfoHeaders({ });
    return await this.queryMultiCompanyInfoWithOptions(request, headers, runtime);
  }
