...
export class ListDeviceHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class ListDeviceResponseBody extends $tea.Model {
  nextToken?: string;
  result?: ListDeviceResponseBodyResult[];
  totalCount?: number;
  static names(): { [key: string]: string } {
    return {
      nextToken: 'nextToken',
  ...
  static types(): { [key: string]: any } {
    return {
      nextToken: 'string',
      result: { 'type': 'array', 'itemType': ListDeviceResponseBodyResult },
      totalCount: 'number',
    };
  }
...
export class QueryFileInfoByMinutesIdHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class QueryFileInfoByMinutesIdRequest extends $tea.Model {
  /**
   * @remarks
   * This parameter is required.
   */
...
export class QueryFileInfoByMinutesIdResponseBody extends $tea.Model {
  result?: QueryFileInfoByMinutesIdResponseBodyResult;
  static names(): { [key: string]: string } {
    return {
      result: 'result',
    };
...
export class QueryFileInfoByMinutesIdResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
  body?: QueryFileInfoByMinutesIdResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      statusCode: 'statusCode',
...
export class ListDeviceResponseBodyResult extends $tea.Model {
...
export class QueryFileInfoByMinutesIdResponseBodyResult extends $tea.Model {
  attributes?: { [key: string]: any };
  createTime?: number;
  creatorUserId?: string;
  duration?: number;
...
export default class Client extends OpenApi {
   ...
   */
  async listDeviceWithOptions(request: ListDeviceRequest, headers: ListDeviceHeaders, runtime: $Util.RuntimeOptions): Promise<ListDeviceResponse> {
    Util.validateModel(request);
    let query : {[key: string ]: any} = { };
    if (!Util.isUnset(request.maxResults)) {
      query["maxResults"] = request.maxResults;
    ...
    return $tea.cast<ListDeviceResponse>(await this.execute(params, req, runtime), new ListDeviceResponse({}));
  }
  ...
  async listDevice(request: ListDeviceRequest): Promise<ListDeviceResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new ListDeviceHeaders({ });
    return await this.listDeviceWithOptions(request, headers, runtime);
  }
   ...
   * @param runtime - runtime options for this request RuntimeOptions
   * @returns QueryFileInfoByMinutesIdResponse
   */
  async queryFileInfoByMinutesIdWithOptions(request: QueryFileInfoByMinutesIdRequest, headers: QueryFileInfoByMinutesIdHeaders, runtime: $Util.RuntimeOptions): Promise<QueryFileInfoByMinutesIdResponse> {
    Util.validateModel(request);
    let query : {[key: string ]: any} = { };
    if (!Util.isUnset(request.minutesId)) {
    ...
    return $tea.cast<QueryFileInfoByMinutesIdResponse>(await this.execute(params, req, runtime), new QueryFileInfoByMinutesIdResponse({}));
  }
   ...
   * @returns QueryFileInfoByMinutesIdResponse
   */
  async queryFileInfoByMinutesId(request: QueryFileInfoByMinutesIdRequest): Promise<QueryFileInfoByMinutesIdResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new QueryFileInfoByMinutesIdHeaders({ });
    return await this.queryFileInfoByMinutesIdWithOptions(request, headers, runtime);
  }
