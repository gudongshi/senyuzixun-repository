...
export class CheckOrderHeaders extends $tea.Model {
...
export class CheckOrderRequest extends $tea.Model {
  /**
   * @remarks
...
export class CheckOrderResponseBody extends $tea.Model {
  errMsg?: string;
  result?: boolean;
  static names(): { [key: string]: string } {
    return {
...
export class CheckOrderResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
  body?: CheckOrderResponseBody;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
...
export default class Client extends OpenApi {
   ...
   * @returns CheckOrderResponse
   */
  async checkOrderWithOptions(request: CheckOrderRequest, headers: CheckOrderHeaders, runtime: $Util.RuntimeOptions): Promise<CheckOrderResponse> {
    ...
    return $tea.cast<CheckOrderResponse>(await this.execute(params, req, runtime), new CheckOrderResponse({}));
  }
   ...
   * @returns CheckOrderResponse
   */
  async checkOrder(request: CheckOrderRequest): Promise<CheckOrderResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers = new CheckOrderHeaders({ });
    return await this.checkOrderWithOptions(request, headers, runtime);
  }
