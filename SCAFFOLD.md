...
```
src/
├── app.tsx              # 应用主组件，特别注意：内容应该被真实的应用内容替换掉
...
用于上传头像、图片、附件、文档等场景。详细文档见 `src/components/upload/README.md`。

### MemberSelector（成员选择器）（可能存在，使用前需要确认）

用于选择成员用户。详细文档见 `src/components/member-selector/README.md`。
